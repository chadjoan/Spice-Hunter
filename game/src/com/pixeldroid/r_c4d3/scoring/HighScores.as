...
package com.pixeldroid.r_c4d3.scoring 
{
	...
	*/
	public class HighScores implements IGameHighScoresProxy
	{
		...
		*/
		public function HighScores(id:String=null, maxScores:int=10) {
			...
			if(id) openHighScoresTable(id);
		}

		/** @inheritdoc */
		public function openHighScoresTable(gameId:String):void
		{
		...
		/** @inheritdoc */
		public function closeHighScoresTable():void
		{
			store();
			_gameId = null;
		}
