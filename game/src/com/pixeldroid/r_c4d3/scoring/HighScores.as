...
package com.pixeldroid.r_c4d3.scoring {
	...
	*/
	public class HighScores {
		...
		*/
		public function HighScores(id:String, maxScores:uint=100) {
		...
		*/
		public function isEligible(s:Number):Boolean {
			return (
				(s > 0)
				&&
				((scores.length < MAX_SCORES) || (scores[scores.length - 1] < s))
			);
		}
		...
		*/
		public function getScore(i:uint):Number {
		...
		*/
		public function getInitials(i:uint):String {
		...
		*/
		...
		protected function initialize(id:String=null):void {
			// sub-classes should override this method
			reset();
		}
