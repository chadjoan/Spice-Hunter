...
package com.pixeldroid.r_c4d3.scoring {
	...
	* 
	* @see com.pixeldroid.r_c4d3.scoring.HighScores
	...
	*/
	public class RemoteHighScores extends HighScores implements IEventDispatcher {
		...
		*/
		...
		/** @inheritdoc */
		override public function closeHighScoresTable():void
		{
			super.closeHighScoresTable();
		...
		/** @inheritdoc */
		override public function openHighScoresTable(gameId:String):void
		{
			super.openHighScoresTable(gameId);
