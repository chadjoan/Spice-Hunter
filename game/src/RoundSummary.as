...
public class RoundSummary implements IDrawable
  {
  ...
  public function draw( backbuffer : BitmapData ) : void
    ...
    // stuff infront of background
    backbuffer.draw(bottomBlurb,
                    bottomBlurb.transform.matrix,
                    bottomBlurb.transform.colorTransform,
                    null,null,true);
    
    backbuffer.draw(pressAnyKey,
                    pressAnyKey.transform.matrix,
                    pressAnyKey.transform.colorTransform,
                    null,null,true);
    }
