package {
  public class UpgradeAI
    ...
    private var menu : GarageMenu;
   
  
            
    public function UpgradeAI (_spec : ShipSpec, _menu : GarageMenu)
      {
      spec = _spec;
      menu = _menu;
    ...
    public function update (deltaT:Number) : void
      ...
      switch (state)
        ...
        case STATE_DECIDING:          
          ...
          var best : Number = 0;
          for (var i : Number = 1; i < toolcosts.length; i++)
        ...
        case STATE_NAVIGATING:
          ...
          if (menu.selection < navigation_target)
            menu.navigateDown(null);
          else
            menu.navigateUp(null);  
        break;
        case STATE_DONE:
