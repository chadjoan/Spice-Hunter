class Environment
  ...
  public function Environment ()
    ...
    for (var a:Number=0; a < 5; a++)
      ...
      // Randomize velocity.
      var v:Number = Math.random()*4.0 + 1.0;
  ...
  public function findBody(x:Number, y:Number) : Body
    ...
    for (var a:Number = 0; a < asteroids.length; a++)
      ...
      if (d < foundBody.collision_radius)
        {
        _root.cout.text = "Clicked on Asteroid " + a;
        return foundBody;
        }
      }
    ...
    for (var s:Number = 0; s < spices.length; s++)
      ...
      if (d < foundBody.collision_radius)
        {
        _root.cout.text = "Clicked on Spice " + s;	
        return foundBody;
        }
      } 
    ...
    for (var hb:Number = 0; hb < homebases.length; hb++)
      ...
      if (d < foundBody.collision_radius)
        {
        _root.cout.text = "Clicked on HomeBase " + hb;		
        return foundBody;
        }
      }
    ...
    for (var sh:Number = 0; sh < ships.length; sh++)
      ...
      if (d < foundBody.collision_radius)
        {
        _root.cout.text = "Clicked on Ship " + sh;		
        return foundBody;
        }
      }
